            ...
            <div class="p-8">
                @if ($errors->any())
                    <div class="bg-red-50 border-l-4 border-red-400 text-red-700 px-6 py-4 rounded-lg mb-8">
                        <div class="flex">
                            <svg class="w-24 h-24 mr-3 text-red-400" fill="currentColor" viewBox="0 0 20 20">
                ...
                <form action="{{ route('objectives.store') }}" method="POST" class="space-y-8">
                    ...
                    <div class="space-y-3">
                        ...
                        @error('obj_title')
                            <p class="text-sm text-red-600 flex items-center">
                                <svg class="w-24 h-24 mr-1" fill="currentColor" viewBox="0 0 20 20">
                                    <path fill-rule="evenodd" d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-7 4a1 1 0 11-2 0 1 1 0 012 0zm-1-9a1 1 0 00-1 1v4a1 1 0 102 0V6a1 1 0 00-1-1z" clip-rule="evenodd"></path>
                                </svg>
                                {{ $message }}
                            </p>
                    ...
                    <div class="sm:col-span-3">
                        ...
                        <div class="mt-2 grid grid-cols-1">
                            ...
                            <svg viewBox="0 0 16 16" fill="currentColor" data-slot="icon" aria-hidden="true" class="pointer-events-none col-start-1 row-start-1 ml-auto mr-2 h-24 w-24 self-center text-gray-500">
